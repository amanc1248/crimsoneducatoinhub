...
export const AssignedCoursesModal = ({show, setShow, individualTutor,setRefresh})=>{
    ...
    const ac = [
      {
          _id: "6362a5a5b882d752b3912716",
          courseName: 2,
          startDate: "2021-1-25",
          endDate: "2022-12-5"
      },
      {
          _id: "6362a5b8b882d752b3912717",
          courseName: 3,
          startDate: "2021-1-25",
          endDate: "2022-12-5"
      },
      {
          _id: "6362a7b8be6e9c1fcb97e474",
          courseName: 4,
          startDate: "2021-1-25",
          endDate: "2022-12-5"
      }
    ...
    const [assignedCourses, setAssignedCourses] =  useState(individualTutor?.assignedCourses);
